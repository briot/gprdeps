use crate::{
    ...
    action_importpath::ActionImportPath, action_unused::ActionSourceUnused,
...
pub fn parse_cli() -> Result<(Settings, Action), Error> {
    let matches = Command::new("gprdeps")
        ...
        .subcommand(
            Command::new("source")
                ...
                .subcommand(
                    Command::new("importpath")
                        .about("Show how FILE1 imports FILE2")
                        .args([
    ...
    let act = match matches.subcommand() {
        ...
        Some(("source", sub)) => match sub.subcommand() {
            ...
            Some(("importpath", importsub)) => {
                Action::ImportPath(ActionImportPath {
